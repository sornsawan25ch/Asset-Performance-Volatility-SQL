...
All assets were impacted by high uncertainty during Covid19 pandemic and how portfolio manager will use data to answer the following questions:

How have asset risk and performance been since Covid19 pandemic began? How to allocate assets in a portfolio to mitigate risk? (Assume the portfolio manager doing data analytics at the end year of 2020 and at the beginning portfolio combines with equity 40%, bond 40%, gold 10%, and real estate 10%.) What asset will be an investment opportunity to allocate based on your data? (Assume that the portfolio manager doing data analytics again in the first half of 2022)


### Step2: Prepare

This project analyzes asset performance, volatility, and also economic factors to allocate assets in a portfolio. The relevant data are asset prices, economic indicators, and covid new cases.
...
1. Check the data format in each dataset 

2. Check the data type in each column
...
### How have asset risk and performance been since Covid19 Pandemic began?

Asset Performance: Covid19 began in December 2019 and spread out around the world. After 3 months the virus is still hard to control, Investors panic and are sensitive to fast Covid pandemics which bring volatility to the market. Equity’s YTD dropped from 45.91% to 24.99%, and Gold’s YTD kept higher near equity’s YTD. While real estate’s YTD decreased from 16.21% to -10.83% and was lower than bond’s YTD.
...
Portfolio Return and Volatility: The portfolio cumulative return dropped in March 2020 from 26.12% to 17.53% as market panic about Covid19 spread brought a large drop in equity which the portfolio holds around 40 percent. However, 2 months later the portfolio rebounded to the same level and increased to 36.76%. Portfolio variance increased since March 2020 from 3.58% and moved to 4.53% in December 2020. It shows portfolios tend to be volatile more in the next year and need to reduce portfolio risk as the number of Covid new cases still increase.
...
### What asset will be an investment opportunity to allocate based on your data? (Assume that the portfolio manager doing data analytics again at the first half of 2022)


Market View: Covid pandemic was relieved in the first quarter of 2022 after the number of Covid new cases went to the peak in January 2022 (Figure 8). Economic recovery from a shutdown, inflation increased to 9% in June 2022 and the Federal Reserve Bank decided to increase interest rates from March 2022 and hike rates again by large and fast from 0.33% to 1.58% in June 2022 (Figure 9).
...
Changing of interest rates large and fast pressure on many assets. For equity, companies will run businesses with higher financing costs. The bond market will get price pressure when the interest rate is higher. Higher opportunity cost for gold investors as holding gold cannot get interest or dividends. Lower home purchasing power will put pressure on demand in the real estate market. Based on the business cycle, we are in the stage of full expansion in the first half of 2022. Under high inflation and hawkish interest rate policy (figure 9), although businesses will get higher financing costs, at the same time the growth of demand and productivity will be a positive factor for business growth at this stage. So equity should be overweight on the portfolio and we underweight on bonds as interest rate has a high effect on bond price directly. Neutral for gold as gold is a good asset for a long-term hedge against inflation, but underweight for real estate as the growth of the real estate sector was pressured by lower house demand from higher home financing costs.
...
- By the end of 2020, reducing the portion of high-volatility assets is the way to mitigate portfolio risk. So recommend underweight equity and real estate.

- In the first half of 2022, High inflation is concerning. After the Covid19 relief, the Federal Reserve Bank started to hike rates. This occurs in the full expansion stage of the business cycle. Equity will be a good opportunity as the demand and 
...
Create a dashboard in Tableau to present asset allocation by considering the performance and volatility risk of asset class and portfolio. Moreover, using economic indicators and Covid19 new cases to make investment decisions to mitigate risk and optimize return. 
...
Stage1 : The economy weakens and the central bank loses monetary policy by cutting interest rates.
...
Stage5 : At a peak of economic growth. The economy grows at a slower pace because of rising interest rates.
